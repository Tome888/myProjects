        ...
        <div className="p-t-40">
          <div className="flex-c-m flex-w p-b-18">
            <a href="#" className="m-all-1">
              <img src="/images/icons/icon-pay-01.png" alt="Payment Icon 1" />
            </a>
            <a href="#" className="m-all-1">
              <img src="/images/icons/icon-pay-02.png" alt="Payment Icon 2" />
            </a>
            <a href="#" className="m-all-1">
              <img src="/images/icons/icon-pay-03.png" alt="Payment Icon 3" />
            </a>
            <a href="#" className="m-all-1">
              <img src="/images/icons/icon-pay-04.png" alt="Payment Icon 4" />
            </a>
            <a href="#" className="m-all-1">
              <img src="/images/icons/icon-pay-05.png" alt="Payment Icon 5" />
            </a>
          </div>
        </div>
      </div>
